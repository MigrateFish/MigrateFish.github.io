---
description: 这个网站将会记录MC插件开发
icon: hand-wave
---

# 欢迎来到Journey\_Fish的插件学习日记

我是一名腐竹，从最初的start.bat到现在，差不多有近三年时间。这三年里我曾无数次想自己编写插件来让我的服务器更加有趣，但最终都不了了之。但随着服务器版本更新，在最新的26版本中，大量老牌插件或是停更，或是更新缓慢。为了服务器的继续运营，我下定决心要精通插件编写。

然而我翻遍B站，MCBBS，Minebbs，网易开发者论坛，都无法找到一个详细，系统，易学的插件开发教程。为此我在这里，将我学习过程一一记录在此。
